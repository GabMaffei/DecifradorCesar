def abreDicionario():
    ...
    """
    varTemp = list()
    with open ('dicionario.txt', 'r') as frase: #unica alteração entre nossos códigos, o ".txt" teve de ser adicionado aqui
...
def descobreCod(wordsLs, dictionary):
    ...
    :param dictionary: dicionario de palavras conhecidas (que é uma lista)
